...
// Завдання 5: Дано масив рядків. За допомогою циклу for переберіть масив, виведіть кожен елемент на консоль 
...
function concatenateStrings(array, subString) {
	...
	let b = a.includes(subString);
  
	console.log("Рядок:", a);
	console.log("Містить підрядок", subString + "?", b);
...
function replaceNumbers(arr) {
	...
	for (let i = 0; i < arr.length; i++) {
		if (arr[i] > 10) {
			mas.push("Greater than 10");
		} else {
			mas.push("Less than or equal to 10");
		}
